...
<body>
    <div class="container-fluid">
        <div class="col-lg-5 area">
            <h1 class="text-center" style="color: #545a5a;">D A T A B A S E</h1>
            <h2 class="text-center" style="color: #545a5a; font-family: Verdana, Geneva, Tahoma, sans-serif;">Mahasiswa</h2>
